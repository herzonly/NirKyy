        ...
        <div class="card mb-3" style="border:1px solid #00ff7f;background-color:#222;color:#00ff7f;">
          ...
          <div class="card-body">
            <div class="mb-2">
              ${
                (ep.tags || []).map(t => 
                  `<span class="badge badge-secondary mr-1" style="background-color:#ff00ff;color:#fff;"><i class="fas fa-hashtag"></i> ${t}</span>`
                ).join('')
              }
            </div>
...
app.get('/renderpage', (req, res) => {
  ...
  const fullHTML = `
    ...
    <head>
      ...
      <style>
        body { background-color: #111; color: #00ff7f; font-family: 'Orbitron', sans-serif; }
      </style>
    </head>
    <body>
      <div class="container">
