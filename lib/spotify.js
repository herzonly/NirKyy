...
module.exports = async (req, res) => {
  try {
    ...
    res.succesJson({note:"Kalo audio Gak ada pas di Fetch Saran aje nih ye, pake UserAgent ya sama referer, coba aja pake user Agent dulu kalo masih sama baru tambahin referer", download: downloadUrl})
  } catch (error) {
