...
module.exports = async (req, res) => {
  try {
    ...
    if (!progressRes.data || progressRes.data.success !== 1 || !progressRes.data.download_url) {
      return res.errorJson('Download belum siap', 503);
    }
    
    const audioRes = await axios.get(progressRes.data.download_url, {
